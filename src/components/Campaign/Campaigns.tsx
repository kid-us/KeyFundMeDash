    ...
    <>
      ...
      {campaigns && campaigns.length > 0 ? (
        campaigns.map((c) => (
          <div
            key={c.fid}
            className="lg:grid md:grid grid-cols-4 flex flex-nowrap overflow-x-auto scroll-snap-x gap-x-5 snap-container custom-scrollbar mb-4 bg-white rounded-xl shadow lg:p-5 py-4"
          >
            {/* Fundraising Info */}
            <div className="col-span-2 lg:grid lg:grid-cols-1 w-[100%] flex-none snap-start px-2">
            ...
            {/* Fundraiser Info */}
            <div className="col-span-2 lg:w-full w-[100%] flex-none snap-start px-2">
        ...
        <div className="mt-5">
          <p>
            There are no active pending campaigns at the moment. When available,
